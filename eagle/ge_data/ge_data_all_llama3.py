...
bigname = "/data_train/infra/glj/models/Meta-Llama-3-70b-Instruct/"
...
def build_dataset_rank(
    ...
    ds = load_dataset('json', data_files="/data_train/infra/glj/datasets/ShareGPT_Vicuna_unfiltered/ShareGPT_V4.3_unfiltered_cleaned_split.json")
    ds = ds['train']
