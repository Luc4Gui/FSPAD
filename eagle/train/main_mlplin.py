...
from ..model.cnets_mlplin import Model
...
if accelerator.is_main_process:
    ...
    wandb.init(project="ess", config=train_config)
...
testevaldatapath = list_files('/cpfs01/user/xiaobin/glj/datasets/Spe_eval_merge_7b/sharegpt_0_479_mubf16')
