...
accelerate launch -m --mixed_precision=bf16 --main_process_port 29508 eagle.train.main_fspad \
    --tmpdir /cpfs01/user/xiaobin/glj/datasets/ShareGPT_Vicuna_onnorm/sharegpt_0_67999_mubf16/ \
    --cpdir /cpfs01/user/xiaobin/glj/models/eagle/vicuna-7b-v1.5_fsapd_0726 \
